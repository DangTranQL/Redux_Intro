...
const CartPage = (props) => {
  ...
  const totalPrice = useSelector((props)=>props.cart.totalPrice)
...
const ProductOne = (props) => {
  ...
  const product = useSelector((props)=>props.product['0'])
...
const ProductTwo = (props) => {
  ...
  // You should see the price is updated
  const product = useSelector((props)=>props.product['1'])
...
const CartProductOne = (props) => {
  ...
  const product = useSelector((props)=>props.cart.products['0']);
  // console.log(product)
...
const CartProductTwo = (props) => {
  ...
  // Change the price of products in `service/cart/slice.js` to see the effect
  const product = useSelector((props)=>props.cart.products['1']);
  // console.log(product)
...
const Store = (props) => {
  ...
  const product = useSelector((props)=>props.product)
